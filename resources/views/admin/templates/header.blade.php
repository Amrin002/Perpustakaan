...
<html lang="en">
    ...
    <head>
        ...
        <!-- Favicons -->
        <link href="{{ asset('assets/img/logo1.png') }}" rel="icon" type="image/png">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                {{-- <li class="nav-item dropdown user-menu">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                        <img src="{{ asset('asset/dist/img/akbar.png') }}" class="user-image img-circle elevation-2"
                alt="User Image">
                <span class="d-none d-md-inline">La Ode Muhammad Akbar</span>
                </a>
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right"> --}}
                    <!-- User image -->
                    {{-- <li class="user-header bg-primary">
                            <img src="{{ asset('asset/dist/img/akbar.png') }}" class="img-circle elevation-2"
                    alt="User Image">

                    <p>
                        La Ode Muhammad Akbar - Web Developer
                        <small>Member Local Class Technology Jun. 2022</small>
                    </p>
                    </li> --}}
                    <!-- Menu Body -->
                    {{-- <li class="user-body">
